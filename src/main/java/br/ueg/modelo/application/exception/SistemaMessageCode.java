...
public enum SistemaMessageCode implements MessageCode {
	...
	ERRO_TAMANHO_INSUFICIENTE_FILTRO_TAMANHO("MSG-T-001", 400),
	ERRO_TAMANHO_DUPLICADO("MSG-T-002",400),


	ERRO_TAMANHO_INSUFICIENTE_FILTRO_SABOR("MSG-S-001", 400),
	ERRO_SABOR_DUPLICADO("MSG-T-002",400),
            ;
